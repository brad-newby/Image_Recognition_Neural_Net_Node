...
#
# Generated by export_simulation on Thu Nov 19 11:06:51 -0600 2020
#
################################################################################
...
'-reset_run' switch to the './sigmoid_0.sh' script.

./sigmoid_0.sh -reset_run
...
./sigmoid_0.sh -noclean_files

For more information on the script, please type './sigmoid_0.sh -help'.
